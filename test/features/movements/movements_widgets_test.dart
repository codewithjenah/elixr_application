  ...
  return MultiProvider(
    ...
    providers: [
      ChangeNotifierProvider<TraineeProgressionService>(
        create: (_) =>
            TraineeProgressionService.ready(totalXp: (level - 1) * 250),
      ),
...
Widget wrapWithProgression(
  ...
  wrap(child, highContrast: highContrast, disableAnimations: disableAnimations),
  level: level,
);
...
void main() {
  ...
  group('MovementCard', () {
    testWidgets(
      'fully locked movement hides its identity and cannot activate',
      (tester) async {
        ...
        expect(
          find.text('Hold the bottle with an underhand grip.'),
          findsNothing,
        );
    ...
    testWidgets('movement identity appears at its required level', (
      tester,
    ) async {
      await tester.pumpWidget(
        wrapWithProgression(
    ...
    testWidgets(
      'mystery card remains identifiable with high contrast and reduced motion',
      (tester) async {
        await tester.pumpWidget(
          wrapWithProgression(
            const SizedBox(
    ...
    testWidgets('shows average rubric and practice-again for practiced', (
      ...
      expect(find.text('Average 8/12'), findsOneWidget);
  ...
  group('theme readability', () {
    testWidgets('header and cards render in light theme', (tester) async {
      ...
      expect(find.text('Average 9/12'), findsOneWidget);
    });
