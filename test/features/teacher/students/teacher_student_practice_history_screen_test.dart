...
void main() {
  ...
  testWidgets('saved images load only after the teacher requests them', (
    ...
    expect(find.textContaining('66.7%'), findsNothing);
    ...
    expect(find.text('8/12'), findsWidgets);
    expect(find.text('Good'), findsWidgets);
    expect(find.text('Competent'), findsNothing);
    expect(find.text('Form: 2/3'), findsOneWidget);
    expect(find.text('Control: 2/3'), findsOneWidget);
    expect(find.text('Finish: 2/3'), findsOneWidget);
