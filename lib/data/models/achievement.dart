...
>[
  ...
  AchievementDefinition(
    ...
    description:
        'Reach ${AssessmentScoreDisplay.performanceLabel(PerformanceLevel.proficient)} (10 of 12) in a session.',
  ...
  AchievementDefinition(
    ...
    description:
        'Reach ${AssessmentScoreDisplay.performanceLabel(PerformanceLevel.mastered)} with a perfect 12 of 12 in a session.',
    category: AchievementCategory.score,
